...
export function SpiralAnimation() {
  ...
  // SSR-safe: initialise to 0, set real values in useEffect
  ...
  useEffect(() => {
    ...
    // Cap DPR at 2 — 3× screens draw 9× more pixels for no visible gain
    ...
    // Pause the GSAP timeline when the hero is off-screen
